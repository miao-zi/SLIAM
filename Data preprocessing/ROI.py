        ...
        for sub_file in sub_folder:
            ...
            for i in range(1, len(location)):
                ...
                if Id == id_:
                    ...
                    x = cx - 71
                    y = cy - 71
                    new_img = dataset.pixel_array[y:(y + 150), x:(x + 150)]
...
if __name__ == "__main__":
    nii_path = r'./home/miaoyu/MY\ROI'  # The path of original masks.
    nii_slice_save = r'./home/miaoyu/MY\nii_slice'  # The path of sliced masks.
    csv_save = r'./home/miaoyu/MY\recta_cancer'  # The path to store the coordinate information of ROI.
    dicom_path = r'./home/miaoyu/MY\dicom'  # The path of original images(Dicom).
    sort_path = r'./home/miaoyu/MY\dicom_sort'  # The path to store the sorted Dicom.
    rec_save_path = r'./home/miaoyu/MY\rec_save'  # The path to store the new patches.
